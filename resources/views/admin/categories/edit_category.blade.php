...
<form id="categorieForm" action="{{ route('admin.update.categorie')}}" method="POST">
    @csrf
    <div class="card">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" value="{{$datas->name}}" id="name" class="form-control" placeholder="Name" autocomplete="name"required >
                        <p></p>
                    </div>	
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="slug" value="{{$datas->slug}}" id="slug" class="form-control" placeholder="Slug" autocomplete="off" required>	
                        <p></p>
                    </div>
                </div>	
                <div class="col-md-6">
