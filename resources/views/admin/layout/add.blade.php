...
<html lang="en">
	<head>
        ...
        <link rel="stylesheet" href="{{asset('admin_asset/plugins/dropzone/dropzone.css')}}">
	...
	<body class="hold-transition sidebar-mini">
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link p-0 pr-3" data-toggle="dropdown" href="#">
							<img src="{{ asset('admin_asset/img/avatar5.png')}}" class='img-circle elevation-2' width="40" height="40" alt="">
						</a>
		...
		<!-- AdminLTE App -->
		<script src="{{ asset('admin_asset/js/adminlte.min.js')}}"></script>

		<!-- Include SweetAlert -->
		<script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
		<script src="{{ asset('admin_asset/js/pages/sweetalert.js')}}"></script>

		<script src="{{ asset('admin_asset/plugins/summernote/summernote-bs4.min.js')}}"></script>
        <script src="{{ asset('admin_asset/plugins/dropzone/dropzone.js')}}"></script>
