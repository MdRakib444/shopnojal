            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                        <a href="home-04-light.html" class="biolife-logo"><img src="{{ asset('front_asset/assets/images/organic-4.png')}}" alt="biolife logo" width="135" height="36"></a>
                    </div>
                                                    ...
                                                    <ul class="posts">
                                                        <li>
                                                            <div class="block-post-item">
                                                                <div class="thumb"><a href="#"><img src="{{ asset('front_asset/assets/images/megamenu/thumb-05.jpg')}}" width="100" height="73" alt=""></a></div>
                                                                <div class="left-info">
                                                        ...
                                                        <li>
                                                            <div class="block-post-item">
                                                                <div class="thumb"><a href="#"><img src="{{ asset('front_asset/assets/images/megamenu/thumb-06.jpg')}}" width="100" height="73" alt=""></a></div>
                                                                <div class="left-info">
                                                                    <h4 class="post-name"><a href="#">Ashwagandha: The #1 Herb in the World for Anxiety?</a></h4>
                                                        ...
                                                        <li>
                                                            <div class="block-post-item">
                                                                <div class="thumb"><a href="#"><img src="{{ asset('front_asset/assets/images/megamenu/thumb-07.jpg')}}" width="100" height="73" alt=""></a></div>
                                                                <div class="left-info">
                                                                    <h4 class="post-name"><a href="#">Ashwagandha: The #1 Herb in the World for Anxiety?</a></h4>
                                        ...
                                        <div class="cart-inner">
                                            <ul class="products">
                                                ...
                                                <li>
                                                    <div class="minicart-item">
                                                        <div class="thumb">
                                                            <a href="#"><img src="{{ asset('front_asset/assets/images/minicart/pr-02.jpg')}}" width="90" height="90" alt="National Fresh"></a>
                                                        </div>
                                                        <div class="left-info">
                                                            <div class="product-title"><a href="#" class="product-name">National Fresh Fruit</a></div>
                                                            <div class="price">
                                                ...
                                                <li>
                                                    <div class="minicart-item">
                                                        <div class="thumb">
                                                            <a href="#"><img src="{{ asset('front_asset/assets/images/minicart/pr-03.jpg')}}" width="90" height="90" alt="National Fresh"></a>
                                                        </div>
                                                        <div class="left-info">
                                                            <div class="product-title"><a href="#" class="product-name">National Fresh Fruit</a></div>
                                                            <div class="price">
                                                ...
                                                <li>
                                                    <div class="minicart-item">
                                                        <div class="thumb">
                                                            <a href="#"><img src="{{ asset('front_asset/assets/images/minicart/pr-04.jpg')}}" width="90" height="90" alt="National Fresh"></a>
                                                        </div>
                                                        <div class="left-info">
                                                            <div class="product-title"><a href="#" class="product-name">National Fresh Fruit</a></div>
                                                            <div class="price">
                                                ...
                                                <li>
                                                    <div class="minicart-item">
                                                        <div class="thumb">
                                                            <a href="#"><img src="{{ asset('front_asset/assets/images/minicart/pr-05.jpg')}}" width="90" height="90" alt="National Fresh"></a>
                                                        </div>
                                                        <div class="left-info">
                                                            <div class="product-title"><a href="#" class="product-name">National Fresh Fruit</a></div>
                                                            <div class="price">
                            ...
                            <div class="vertical-menu vertical-category-block always ">
                                ...
                                <div class="wrap-menu">
                                    <ul class="menu clone-main-menu">
                                        <li class="menu-item menu-item-has-children has-megamenu">
                                            <a href="#" class="menu-name" data-title="Fruit & Nut Gifts"><i class="biolife-icon icon-fruits"></i>Fruits & Vegetables</a>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-4 col-sm-12 xs-margin-bottom-25 md-margin-bottom-0">
                                                            <div class="wrap-custom-menu vertical-menu">
                                                                ...
                                                                <ul class="menu">
                                                                    <li><a href="{{route('front.fruits')}}">Fresh Fruits</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3 col-md-4 col-sm-12 lg-padding-left-23 xs-margin-bottom-25 md-margin-bottom-0">
                                                            <div class="wrap-custom-menu vertical-menu">
                                                                ...
                                                                <ul class="menu">
                                                                    <li><a href="{{ route('front.vegetable')}}">Fresh Vegetables</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <ul class="products-list default-product-style biolife-carousel nav-none-after-1k2 nav-center" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":30,"slidesToShow":1, "responsive":[{"breakpoint":767, "settings":{ "arrows": false}}]}' >
                                                                        ...
                                                                        <div class="contain-product none-overlay">
                                                                            <div class="product-thumb">
                                                                                <a href="#" class="link-to-product">
                                                                                    <img src="{{ asset('front_asset/assets/images/products/p-08.jpg')}}" alt="dd" width="270" height="270" class="product-thumnail">
                                                                                </a>
                                                                            </div>
                                                                            <div class="info">
                                                                    ...
                                                                    <li class="product-item">
                                                                        <div class="contain-product none-overlay">
                                                                            <div class="product-thumb">
                                                                                <a href="#" class="link-to-product">
                                                                                    <img src="{{ asset('front_asset/assets/images/products/p-11.jpg')}}" alt="dd" width="270" height="270" class="product-thumnail">
                                                                                </a>
                                                                            </div>
                                                                            <div class="info">
                                                                                <b class="categories">Fresh Fruit</b>
                                                                    ...
                                                                    <li class="product-item">
                                                                        <div class="contain-product none-overlay">
                                                                            <div class="product-thumb">
                                                                                <a href="#" class="link-to-product">
                                                                                    <img src="{{ asset('front_asset/assets/images/products/p-15.jpg')}}" alt="dd" width="270" height="270" class="product-thumnail">
                                                                                </a>
                                                                            </div>
                                                                            <div class="info">
                                                                                <b class="categories">Fresh Fruit</b>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 md-margin-top-9">
                                                            <div class="biolife-brand" >
                                                                <ul class="brands">
                                                                    <li><a href="#"><img src="{{ asset('front_asset/assets/images/megamenu/brand-organic.png')}}" width="161" height="136" alt="organic"></a></li>
                                                                    <li><a href="#"><img src="{{ asset('front_asset/assets/images/megamenu/brand-explore.png')}}" width="160" height="136" alt="explore"></a></li>
                                                                    <li><a href="#"><img src="{{ asset('front_asset/assets/images/megamenu/brand-organic-2.png')}}" width="99" height="136" alt="organic 2"></a></li>
                                                                    <li><a href="#"><img src="{{ asset('front_asset/assets/images/megamenu/brand-eco-teas.png')}}" width="164"  height="136" alt="eco teas"></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <li class="menu-item menu-item-has-children has-megamenu">
                                            <a href="#" class="menu-name" data-title="Vegetables"><i class="biolife-icon icon-broccoli-1"></i>Meat & Fish</a>
                                            <div class="wrap-megamenu lg-width-900 md-width-640 background-mega-01">
                                                <div class="mega-content">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-4 col-sm-12 xs-margin-bottom-25 md-margin-bottom-0">
                                                            <div class="wrap-custom-menu vertical-menu">
                                                                <h4 class="menu-title">Meat</h4>
                                                                <ul class="menu">
                                                                    <li><a href="{{route('front.meat')}}">Meat</a></li>
                                                                    <li><a href="{{route('front.premium.meat')}}">Premium Meat</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4 col-md-4 col-sm-12 lg-padding-left-23 xs-margin-bottom-25 md-margin-bottom-0">
                                                            <div class="wrap-custom-menu vertical-menu">
                                                                <h4 class="menu-title">Fish</h4>
                                                                <ul class="menu">
                                                                    <li><a href="{{route('front.fish')}}">Fish</a></li>
                                                                    <li><a href="{{ route('front.premium.fish')}}">Premium Fish</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-5 col-md-4 col-sm-12 lg-padding-left-57 md-margin-bottom-30">
                                                            <div class="biolife-brand vertical md-boder-left-30">
                                                                ...
                                                                <ul class="brands">
                                                                    <li><a href="#"><img src="{{ asset('front_asset/assets/images/megamenu/v-brand-organic.png')}}" width="167" height="74" alt="organic"></a></li>
                                                                    <li><a href="#"><img src="{{ asset('front_asset/assets/images/megamenu/v-brand-explore.png')}}" width="167" height="72" alt="explore"></a></li>
                                                                    <li><a href="#"><img src="{{ asset('front_asset/assets/images/megamenu/v-brand-organic-2.png')}}" width="167" height="99" alt="organic 2"></a></li>
                                                                    <li><a href="#"><img src="{{ asset('front_asset/assets/images/megamenu/v-brand-eco-teas.png')}}" width="167" height="67" alt="eco teas"></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <li class="menu-item menu-item-has-children has-megamenu">
                                            <a href="#" class="menu-name" data-title="Fresh Berries"><i class="biolife-icon icon-grape"></i>Cooking</a>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-4 sm-col-12 md-margin-bottom-83 xs-margin-bottom-25">
                                                            <div class="wrap-custom-menu vertical-menu">
                                                                ...
                                                                <ul class="menu">
                                                                    <li><a href="{{route('front.spices')}}">Spices</a></li>
                                                                    <li><a href="{{ route('front.salt.sugar')}}">Salt & Sugar</a></li>
                                                                    <li><a href="{{ route('front.rice')}}">Rice</a></li>
                                                                    <li><a href="{{ route('front.dal.lentis')}}">Dal Or Lentis</a></li>
                                                                    <li><a href="{{ route('front.ready.mix')}}">Ready Mix</a></li>
                                                                    <li><a href="{{route('front.shemai.suji')}}">Shemai & Suji</a></li>
                                                                    <li><a href="{{route('front.oil')}}">Oil</a></li>
                                                                    <li><a href="{{  route('front.ghee')}}">Ghee</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                        ...
                                        <li class="menu-item menu-item-has-children has-megamenu">
                                            <a href="#" class="menu-name" data-title="Fresh Berries"><i class="biolife-icon icon-grape"></i>Sauces & Pickles</a>
                                            <div class="wrap-megamenu lg-width-900 md-width-640 background-mega-02">
                                                <div class="mega-content">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-4 sm-col-12 md-margin-bottom-83 xs-margin-bottom-25">
                                        ...
                                        <li class="menu-item menu-item-has-children has-megamenu">
                                            <a href="#" class="menu-name" data-title="Fresh Berries"><i class="biolife-icon icon-grape"></i>Dairy & Eggs</a>
                                            <div class="wrap-megamenu lg-width-900 md-width-640 background-mega-02">
                                                <div class="mega-content">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-4 sm-col-12 md-margin-bottom-83 xs-margin-bottom-25">
                                        ...
                                        <li class="menu-item menu-item-has-children has-megamenu">
                                            <a href="#" class="menu-name" data-title="Fresh Berries"><i class="biolife-icon icon-grape"></i>Breakfast</a>
                                            <div class="wrap-megamenu lg-width-900 md-width-640 background-mega-02">
                                                <div class="mega-content">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-4 sm-col-12 md-margin-bottom-83 xs-margin-bottom-25">
                                        ...
                                        <li class="menu-item menu-item-has-children has-megamenu">
                                            <a href="#" class="menu-name" data-title="Fresh Berries"><i class="biolife-icon icon-grape"></i>Candy & Chocolate</a>
                                            <div class="wrap-megamenu lg-width-900 md-width-640 background-mega-02">
                                                <div class="mega-content">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-4 sm-col-12 md-margin-bottom-83 xs-margin-bottom-25">
                                                            <div class="wrap-custom-menu vertical-menu">
                                                                <h4 class="menu-title">Candy & Chocolate</h4>
                                                                <ul class="menu">
                                                                    <li><a href="#">Chocolates</a></li>
                                                                    <li><a href="#">Wafers</a></li>
                                        ...
                                        <li class="menu-item menu-item-has-children has-megamenu">
                                            <a href="#" class="menu-name" data-title="Fresh Berries"><i class="biolife-icon icon-grape"></i>Snacks</a>
                                            <div class="wrap-megamenu lg-width-900 md-width-640 background-mega-02">
                                                <div class="mega-content">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-4 sm-col-12 md-margin-bottom-83 xs-margin-bottom-25">
                                                            <div class="wrap-custom-menu vertical-menu">
                                                                <h4 class="menu-title">Snacks</h4>
                                                                <ul class="menu">
                                                                    <li><a href="#">Noodles</a></li>
                                                                    <li><a href="#">Cookies</a></li>
                                                                    <li><a href="#">Local Snacks</a></li>
                                        ...
                                        <li class="menu-item menu-item-has-children has-megamenu">
                                            <a href="#" class="menu-name" data-title="Fresh Berries"><i class="biolife-icon icon-grape"></i>Beverages</a>
                                            <div class="wrap-megamenu lg-width-900 md-width-640 background-mega-02">
                                                <div class="mega-content">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-4 sm-col-12 md-margin-bottom-83 xs-margin-bottom-25">
                                        ...
                                        <li class="menu-item"><a href="#" class="menu-name" data-title="Ocean Foods"><i class="biolife-icon icon-fish"></i>Diabetic Food</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <li>
                            <div class="biolife-banner biolife-banner__style-08">
                                <div class="banner-contain">
                                    <div class="media">
                                        <a href="#" class="bn-link"><img src="{{ asset('front_asset/assets/images/home-04/bn_style08.png')}}" width="193" height="185" alt=""></a>
                                    </div>
                                    <div class="text-content">
                    ...
                    <ul class="biolife-carousel nav-center-bold nav-none-on-mobile" data-slick='{"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":30,"slidesToShow":4, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 3}},{"breakpoint":992, "settings":{ "slidesToShow": 3}},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin":10}}, {"breakpoint":500, "settings":{ "slidesToShow": 1}}]}'>
                        ...
                        <!-- <li>
                            <div class="biolife-cat-box-item">
                                <div class="cat-thumb">
                                    <a href="#" class="cat-link">
                                        <img src="{{ asset('front_asset/assets/images/home-04/cat-thumb02.jpg')}}" width="277" height="185" alt="">
                                    </a>
                                </div>
                                <a class="cat-info" href="#">
                        ...
                        <li>
                            <div class="biolife-cat-box-item">
                                <div class="cat-thumb">
                                    <a href="#" class="cat-link">
                                        <img src="{{ asset('front_asset/assets/images/home-04/cat-thumb03.jpg')}}" width="277" height="185" alt="">
                                    </a>
                                </div>
                                <a class="cat-info" href="#">
                        ...
                        <li>
                            <div class="biolife-cat-box-item">
                                <div class="cat-thumb">
                                    <a href="#" class="cat-link">
                                        <img src="{{ asset('front_asset/assets/images/home-04/cat-thumb04.jpg')}}" width="277" height="185" alt="">
                                    </a>
                                </div>
                                <a class="cat-info" href="#">
                                ...
                                <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile eq-height-contain" data-slick='{"rows":1 ,"arrows":true,"dots":false,"infinite":true,"speed":400,"slidesMargin":10,"slidesToShow":4, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin":20 }},{"breakpoint":768, "settings":{ "slidesToShow": 2,"rows":2, "slidesMargin":15 }}]}'>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('front_asset/assets/images/products/p-05.jpg')}}" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                </a>
                                    ...
                                    <!-- <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('front_asset/assets/images/products/p-07.jpg')}}" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('front_asset/assets/images/products/p-02.jpg')}}" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('front_asset/assets/images/products/p-03.jpg" alt="Vegetables" width="270" height="270" class="produ')}}ct-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('front_asset/assets/images/products/p-06.jpg')}}" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('front_asset/assets/images/products/p-20.jpg')}}" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('front_asset/assets/images/products/p-19.jpg')}}" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('front_asset/assets/images/products/p-01.jpg')}}" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('front_asset/assets/images/products/p-18.jpg')}}" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                                ...
                                <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile eq-height-contain" data-slick='{"rows":1 ,"arrows":true,"dots":false,"infinite":true,"speed":400,"slidesMargin":10,"slidesToShow":4, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin":20 }},{"breakpoint":768, "settings":{ "slidesToShow": 2,"rows":2, "slidesMargin":15 }}]}'>
                                    ...
                                    <li class="product-item">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="#" class="link-to-product">
                                                    <img src="{{ asset('front_asset/assets/images/products/p-03.jpg')}}" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                                </a>
                                                <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                            </div>
                                            <div class="info">
                            ...
                            <ul class="products-list biolife-carousel nav-top-right nav-main-color nav-none-on-mobile eq-height-contain" data-slick='{"rows":2 ,"arrows":true,"dots":false,"infinite":true,"speed":400,"slidesMargin":0,"slidesToShow":3, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin": 20}},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin": 15}}]}'>
                                ...
                                <!-- <li class="product-item">
                                    <div class="contain-product layout-default">
                                        <div class="product-thumb">
                                            <a href="#" class="link-to-product">
                                                <img src="{{ asset('front_asset/assets/images/products/p-24.jpg')}}" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                            </a>
                                            <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                        </div>
                                        <div class="info">
                                ...
                                <li class="product-item">
                                    <div class="contain-product layout-default">
                                        <div class="product-thumb">
                                            <a href="#" class="link-to-product">
                                                <img src="{{ asset('front_asset/assets/images/products/p-23.jpg')}}" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                            </a>
                                            <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                        </div>
                                        <div class="info">
