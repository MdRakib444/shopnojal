...
@section('hero_section')
    ...
    <div class="hero-section hero-background">
        <h1 class="page-title">Shemai & Suji</h1>
    </div>
    ...
    <div class="container">
        <nav class="biolife-nav">
            <ul>
                ...
                <li class="nav-item"><a href="#" class="permal-link">Cooking</a></li>
                <li class="nav-item"><span class="current-page">Shemai & Suji</span></li>
            </ul>
        </nav>
    </div>
                    ...
                    <div class="product-category grid-style">
                        ...
                        <div class="row">
                            <ul class="products-list">
                                @foreach($product_shemaiSuji as $product)
