	...
	<div class="container">
        <nav class="biolife-nav">
            <ul>
                ...
                <li class="nav-item"><span class="current-page">Honey</span></li>
            </ul>
        </nav>
    </div>
                    ...
                    <div class="product-category grid-style">
                            ...
                            <div class="flt-item to-right">
                                ...
                                <div class="wrap-selectors">
                                    ...
                                    <div class="selector-item viewmode-selector">
                                        <a href="{{route('front.meat')}}" class="viewmode grid-mode active"><i class="biolife-icon icon-grid"></i></a>
                                        <a href="{{route('front.meat')}}" class="viewmode detail-mode"><i class="biolife-icon icon-list"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <ul class="products-list">
                                @foreach($product_honey as $product)
