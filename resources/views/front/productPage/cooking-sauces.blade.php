...
@section('hero_section')
    ...
    <div class="hero-section hero-background">
        <h1 class="page-title">Cooking Sauces</h1>
    </div>
    ...
    <div class="container">
        <nav class="biolife-nav">
            <ul>
                ...
                <li class="nav-item"><a href="#" class="permal-link">Sauces & Pickles</a></li>
                <li class="nav-item"><span class="current-page">Cooking Sauces</span></li>
            </ul>
        </nav>
    </div>
                    ...
                    <div class="product-category grid-style">
                        ...
                        <div class="row">
                            <ul class="products-list">
                                @foreach($product_cookingSauces as $product)
